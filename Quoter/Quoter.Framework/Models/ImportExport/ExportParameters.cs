...
namespace Quoter.Framework.Models.ImportExport
{
	...
	{
		/// <summary>
		/// If this is True it will export only collections marked as favourite (and their associated books, chapters, quotes),
		/// otherwise it will export all collections
		/// </summary>
